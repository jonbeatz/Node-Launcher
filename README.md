...
> **MSC Media Engine — workspace `package.json` `1.9.6`** (Station Prime; UI/dashboard notes through **v1.9.x** in [`VADER_STATION_LOG.md`](VADER_STATION_LOG.md); build branch history in [`.cursor/docs/Checkpoint.md`](.cursor/docs/Checkpoint.md))
...
**Status:** Approved — release track **`1.9.6`** (Station Prime)  
*Powered by the MSC Media Engine v1.9.6*