...
> **MSC Media Engine — workspace `package.json` `2.0.0`** (Vader Station Core; notes in [`VADER_STATION_LOG.md`](VADER_STATION_LOG.md); build branch history in [`.cursor/docs/guides/Checkpoint.md`](.cursor/docs/guides/Checkpoint.md))
