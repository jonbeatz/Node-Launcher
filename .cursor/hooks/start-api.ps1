# VPE — sessionStart hook (v1.9.9): print integrated-terminal reminder only (no new windows).
...
Write-Host '  Pane 2: .\google-api\vpe-start-api.ps1' -ForegroundColor White
