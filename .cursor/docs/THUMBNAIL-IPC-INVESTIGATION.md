...
**Shipped version (code):** root **`package.json`** — **v1.7.8** finalized the **`vpe-vault:`** / **`?pulse=`** pipeline; **current repo semver** may advance (e.g. **1.9.6**) without changing that protocol story.  
