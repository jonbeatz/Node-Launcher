...
- **Branching (historical, v1.3.1):** introduced **`VPE-v1.3.x-Dev`** (replaces **`Node-Launcher-v11`**). **Active git line (may lag semver):** **`VPE-v1.6.x-Dev`** — shipped **`package.json`** may read **1.9.x** on that line; see **Build v1.9.6** above, then **Build v1.6.0**.
