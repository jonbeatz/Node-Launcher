...
4. **Runtime / packaging:** Prefer launcher owning **3000** during **`npm run dev`** / Vader dev; use **`npm run vader:sync`** when you need **dev → snapshot → syntax guard → Windows pack** (see [VPE-BUILD-PROTOCOL.md](../core/VPE-BUILD-PROTOCOL.md)).
...
- **Aesthetic:** Background **#121212**, surface **#1c1c1c**; Vader accent **#e02b20** for brand/CTAs outside nav. **Navigation selection** (sidebar + maintenance tabs, dashboard pills where applicable): **#2a2a2a** — see [VPE-BUILD-PROTOCOL — Standards](../core/VPE-BUILD-PROTOCOL.md) (v1.3.0+).
