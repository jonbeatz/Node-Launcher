...
| **Launcher port** | Dev UI: **`http://127.0.0.1:3000`** / `localhost:3000` (renderer). **Managed apps must use a higher port**—not the launcher port. |
...
- [ ] VPE Version: **v1.0.8** (see root `package.json` if disputed)
